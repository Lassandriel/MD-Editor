...
* [ ] **Custom Themes**: Allow users to create and load their own CSS themes.
* [ ] **Focus Mode**: A distraction-free mode that hides all UI elements except the editor.
* [ ] **Typewriter Mode**: Keeps the current line centered on the screen.
* [ ] **Vim Mode**: Add Vim keybindings for power users.
